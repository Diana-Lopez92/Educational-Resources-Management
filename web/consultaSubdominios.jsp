<%-- 
    Document   : consultaSubdominios
    Created on : 4/12/2015, 08:47:40 AM
    Author     : Diana
--%>
...
<html>
    <head>
       <meta charset="utf-8">
        ...
        <script type="text/javascript" language="javascript">
            function Borrar(id)
            {
		var resul = confirm('Do you really want to delete the selected subdomain?');
		if (resul)
		{
                ...
                {
                    window.location='consultaSubdominios.jsp';
                }
            }
        </script> 
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                         ...
                         <div class="text-left">
                                   <a href="registroSubdominio.jsp" class="btn btn-primary btn-lg" role="button">Insert</a>
                                </div>
                   <br>
                    </div>
                </div>
        ...
        <%
            ...
            String sql= "select * from subdominios";
            try
            {
                ...
                while(rs.next())
                {
                    ...
                    //out.println("<td><a href=modificarSubdominio.jsp?id=" + rs.getInt("id_dom")+ ">Modify</a>&nbsp&nbsp&nbsp");
                    out.println("<td><a href='#'>Modify</a>&nbsp&nbsp&nbsp");
                    out.println("<a href='#' onclick='Borrar(" + rs.getInt("id_sub") + ")'>Delete</a></td></tr>");
                    out.println("</tr>");
                }
